...
const ProjectDetails = ({
  ...
  return (
    <div 
      className="fixed inset-0 z-50 flex items-center justify-center w-full h-full overflow-y-auto backdrop-blur-sm p-4"
      onClick={closeModal}
    >
      <motion.div
        className="relative max-w-2xl w-full bg-gradient-to-l from-midnight to-navy border border-white/10 rounded-2xl shadow-sm overflow-hidden my-auto"
